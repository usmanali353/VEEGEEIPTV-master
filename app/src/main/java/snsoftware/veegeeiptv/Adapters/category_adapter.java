...
import snsoftware.veegeeiptv.channels_page;


public class category_adapter extends BaseAdapter {
    public category_adapter(List<category> categoryList, Context context) {
      ...
      category_viewholder holder;
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(context, channels_page.class);
