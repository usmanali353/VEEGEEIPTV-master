...
public class JavaActivity extends Activity implements IVLCVout.OnNewVideoLayoutListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OVERLAY / CONTROLS
        mMediaPlayer.setTime(getIntent().getLongExtra("current_position",0));
        ...
        mediaController.setAnchorView(mVideoSurface);
    ...
    protected void onStart() {
        ...
        final Media media = new Media(mLibVLC, Uri.parse(getIntent().getStringExtra("channel_url")));
        mMediaPlayer.setTime(getIntent().getLongExtra("current_position",0));
        ...
        mMediaPlayer.play();
        mMediaPlayer.setTime(getIntent().getLongExtra("current_position",0));
        Log.e("current_position",String.valueOf(getIntent().getLongExtra("current_position",0)));
