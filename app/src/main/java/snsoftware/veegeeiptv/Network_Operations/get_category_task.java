...
public class get_category_task {
    ...
    public get_category_task(Context context, ListView category_list,
        ...
        link.append(password);
        link.append("&action=get_live_categories");
    }
                ...
                link.toString(), new Response.Listener<String>()
        {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals(Variables.errormessage)) {
                    ...
                    categoryList = new Gson().fromJson(response.toString(), new TypeToken<List<category>>() {
                    }.getType());
                    if (categoryList != null && categoryList.size() > 0) {
                        category_list.setAdapter(new category_adapter(categoryList, context));
                    } else {
